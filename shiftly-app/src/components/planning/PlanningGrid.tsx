...
import type { PlanningWeekData } from '@/types/planning'
...
export default function PlanningGrid({ data }: PlanningGridProps) {
  const today = new Date().toISOString().split('T')[0]

  // Génère les 7 dates de la semaine (lundi → dimanche)
  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-[var(--border)] bg-[var(--surface)]">
      {/* En-tête : colonne nom + 7 jours + colonne heures */}
